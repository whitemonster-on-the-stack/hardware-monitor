...
Configuration is currently embedded in the source code. Default layout is defined in `internal/ui/root.go`, so customizing the layout requires editing that file and rebuilding the binary.
